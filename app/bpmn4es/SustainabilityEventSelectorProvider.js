// app/bpmn4es/SustainabilityEventSelectorProvider.js

import { getBusinessObject } from 'bpmn-js/lib/util/ModelUtil';
import { getExtensionElement } from './util.js';

// Exactly the list you want in the submenu:
const INDICATORS = [
  {
    category: 'emissions',
    indicators: [
...
export default function SustainabilityEventSelectorProvider(
  popupMenu,
  modeling,
  moddle,
  translate
  ...
  // Register under exactly the same ID we open:
  popupMenu.registerProvider('sustainability-event-selector', this);
}

SustainabilityEventSelectorProvider.$inject = [
  'popupMenu',
  'modeling',
  'moddle',
  'translate'
...
SustainabilityEventSelectorProvider.prototype.getEntries = function(element) {
  const self = this;
